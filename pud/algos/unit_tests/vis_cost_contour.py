...
if __name__ == "__main__":
    ...
    ax.set_xlabel("x")
    ax.set_ylabel("y")
    ax.set_title("cost contour with resize = {:.2f} radius = {:.2f}".format(args.resize_factor, args.radius))
    fig.colorbar(CS)
    fig.savefig("temp/cost_f_contour_{}_{}_resize={}_r={}.jpg".format(args.maze_name, args.cost_name, args.resize_factor, args.radius), dpi=300)
    plt.close(fig)
